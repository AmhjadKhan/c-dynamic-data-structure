...
struct node*ptr;
ptr=head;
int i=ptr->priority; int pos=0;

while(ptr->next!=NULL){if(i<(ptr->priority)){ i=ptr->priority; }ptr=ptr->next;pos++;}return pos-1;}
